...
const string strMessageMagic = "BitcoinSupreme Signed Message:\n";
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "BitcoinSupreme", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        //  Coinbase(hash=12630d16a9, nTime=1523529630, ver=1, vin.size=1, vout.size=1, nLockTime=0)
        ...
        const char* pszTimestamp = "1523527291 Lasting Lessons From the Holocaust";
        CTransaction txNew;
        txNew.nTime = 1523529630;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1523529630;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = !fTestNet ? 922402 : 922402;
        ...
        assert(block.hashMerkleRoot == uint256("0x8259ab3f6d25493042ad350cd2f8f5a7a83d3c4f81a84371a9cea804829f304e"));
...
unsigned char pchMessageStart[4] = { 0xec, 0xba, 0x02, 0x6b };
